{
  ...
  home-manager.users.zozano.programs.rclone.proton.secrets.user = config.sops.secrets."proton/user".path;
  home-manager.users.zozano.programs.rclone.proton.secrets.pass = config.sops.secrets."proton/pass".path;
